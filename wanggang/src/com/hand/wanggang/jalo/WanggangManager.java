...
/**
 * This is the extension manager of the Wanggang extension.
 */
public class WanggangManager extends GeneratedWanggangManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(WanggangManager.class);
	 ...
	 */
	public static WanggangManager getInstance()
	{
		return (WanggangManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(WanggangConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WanggangManager() // NOPMD 
	{
		LOG.debug("constructor of WanggangManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of WanggangManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of WanggangManager called, current tenant: {}", getTenant().getTenantID());
	}
