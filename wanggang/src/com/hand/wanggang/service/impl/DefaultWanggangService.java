 ...
 */
package com.hand.wanggang.service.impl;
...
public class DefaultWanggangService implements WanggangService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultWanggangService.class);
	...
	{
		return DefaultWanggangService.class.getResourceAsStream("/wanggang/sap-hybris-platform.png");
	}
