 ...
 */
package com.hand.wanggangbackoffice.jalo;
...
import com.hand.wanggangbackoffice.constants.WanggangbackofficeConstants;
 ...
 */
public class WanggangbackofficeManager extends GeneratedWanggangbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WanggangbackofficeManager.class.getName());
	 ...
	 */
	public static WanggangbackofficeManager getInstance()
	{
		return (WanggangbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(WanggangbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WanggangbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WanggangbackofficeManager called.");
		}
	}
