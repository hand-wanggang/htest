 ...
 */
package com.hand.wanggangfrontend.jalo;
...
/**
 * This is the extension manager of the Wanggangfrontend extension.
 */
public class WanggangfrontendManager extends GeneratedWanggangfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(WanggangfrontendManager.class);
	 ...
	 */
	public static WanggangfrontendManager getInstance()
	{
		return (WanggangfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(WanggangfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WanggangfrontendManager() // NOPMD 
	{
		LOG.debug("constructor of WanggangfrontendManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of WanggangfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of WanggangfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
