...
public class DefaultWanggangfrontendService implements WanggangfrontendService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultWanggangfrontendService.class);
	...
	{
		return DefaultWanggangfrontendService.class.getResourceAsStream("/wanggangfrontend/sap-hybris-platform.png");
	}
