 ...
 *
 */
package com.hand.wanggangwebservices.populators;
...
import com.hand.wanggangwebservices.data.AddressData;
...
public class SampleAddressPopulator implements Populator<AddressModel, AddressData>
{
	...
	private static boolean getBoolean(final Boolean val, final boolean def)
	{
