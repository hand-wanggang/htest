...
import com.hand.wanggangwebservices.data.UserData;
import com.hand.wanggangwebservices.data.UserDataList;
import com.hand.wanggangwebservices.dto.SampleWsDTO;
import com.hand.wanggangwebservices.dto.TestMapWsDTO;
import com.hand.wanggangwebservices.dto.UserWsDTO;
import com.hand.wanggangwebservices.dto.UsersListWsDTO;
import com.hand.wanggangwebservices.facades.SampleFacades;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/wanggangwebservices/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/wanggangwebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/wanggangwebservices/sample/users
	 * <li>http://localhost:9001/wanggangwebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/wanggangwebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/wanggangwebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/wanggangwebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/wanggangwebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/wanggangwebservices/sample/users/user1
	 * <li>http://localhost:9001/wanggangwebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/wanggangwebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/wanggangwebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/wanggangwebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/wanggangwebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	@Secured(
	{ "ROLE_CLIENT" })
	 ...
	 *
	 * Url: http://localhost:9001/wanggangwebservices/sample/map
	 *
	 */
